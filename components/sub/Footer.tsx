  ...
  return (
    <footer className="relative w-full py-20 bg-transparent overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="relative w-full h-[400px] md:h-[600px] rounded-[2rem] md:rounded-[4rem] overflow-hidden border border-black/10 dark:border-white/10 shadow-[0_0_50px_-12px_rgba(120,40,200,0.15)] dark:shadow-[0_0_50px_-12px_rgba(120,40,200,0.3)] group">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-white/90 via-white/20 to-transparent dark:from-[#030014]/80 dark:via-transparent dark:to-transparent z-10" />
          <div className="absolute inset-0 bg-gradient-to-b from-white/50 via-transparent to-transparent dark:from-[#030014]/40 dark:via-transparent dark:to-transparent z-10" />

          {/* Minimal Text inside the frame */}
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
             <div className="w-12 h-[1px] bg-white/60 dark:bg-white/20 mb-6 transition-all duration-700 group-hover:w-24 group-hover:bg-purple-500 dark:group-hover:bg-purple-500/50" />
